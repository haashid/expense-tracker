  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl mb-5 relative animate-float"
            ...
            <div className="absolute -top-1 -right-1 w-5 h-5 rounded-full flex items-center justify-center"
              ...
              <ShieldAlert className="w-2.5 h-2.5 text-slate-800" />
            </div>
          </div>
          ...
          <h1 className="text-3xl font-black text-slate-800 tracking-tight">Admin Access</h1>
          <p className="text-sm font-medium mt-1" style={{ color: 'rgba(15, 23, 42, 0.6)' }}>Hasheema's Wedding Registry — Control Center</p>
        </div>
        ...
        <div className="rounded-3xl p-8"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              <label className="block text-xs font-bold uppercase tracking-widest mb-2" style={{ color: 'rgba(15, 23, 42, 0.6)' }}>Admin Email</label>
              <div className="relative">
            ...
            <div className="relative">
              <label className="block text-xs font-bold uppercase tracking-widest mb-2" style={{ color: 'rgba(15, 23, 42, 0.6)' }}>Security Password</label>
              <div className="relative">
            ...
            <button type="submit" disabled={loading}
              className="w-full py-3.5 rounded-2xl font-bold text-slate-800 text-sm flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer transition-all"
          ...
          {isDemoMode && (
            <div className="mt-6 pt-5" style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
              <p className="text-center text-[10px] font-bold uppercase tracking-widest mb-3" style={{ color: 'rgba(15, 23, 42, 0.5)' }}>
        ...
        <p className="text-center text-xs mt-5 flex items-center justify-center gap-1.5" style={{ color: 'rgba(15, 23, 42, 0.4)' }}>
